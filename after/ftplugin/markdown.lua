...
keymap.set('i', ',1', '#<Space><Enter><Enter><++><Esc>kA', { buffer = true })
keymap.set('i', ',2', '##<Space><Enter><Enter><++><Esc>kA', { buffer = true })
keymap.set('i', ',3', '###<Space><Enter><Enter><++><Esc>kA', { buffer = true })
keymap.set('i', ',4', '#####<Space><Enter><Enter><++><Esc>kA', { buffer = true })
keymap.set('i', ',l', '--------<Enter>', { buffer = true })
keymap.set('n', '\\r', '<cmd>CocCommand markdown-preview-enhanced.openPreview<CR>', { silent = true })
